...
export default function LanguageSwitcher({
  ...
  return (
    <button
      ...
      className="flex items-center justify-center w-9 h-9 text-sm font-medium text-gray-700 hover:text-[#669c27] transition-all duration-300 hover:bg-gray-100 border border-gray-200 hover:border-[#669c27] focus:outline-none focus:ring-2 focus:ring-[#669c27] focus:ring-offset-2"
