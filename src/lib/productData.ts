...
جهت استفاده در صنایع سیمان نیروگاه ها و دیگر صنایع می باشد.`,
  ...
  },
  {
    ...
    description_fa: `آنالایزر آنلاین گاز محیطی که جهت استفاده در ایستگاه های سنجش آلودگی هوا ثابت و سیار مورد استفاده قرار می‌گیرد که با دقت بالا گاز های آلاینده رو اندازه گیری میکند`,
...
(O3-CO-SO2-NOX - H2S,...)
 مورد استفاده قرار می‌گیرد.`,
  ...
  },
  {
    ...
    description_fa: `آنالایزر GC (گاز کارماتوگراف) جهت اندازه گیری مشتقات نفتی در محیط صنعتی و شهری مورد استفاده قرار می‌گیرد و به صورت مجزا داده ها رو نمایش می دهد.`,
    longDescription_fa:
  ...
  },
  {
    ...
    description_fa: `آنالایزر آنلاین غبار دودکش که به روش تریبوالکتریک ذرات معلق خروجی از دودکش ها را اندازه گیری می کند و جهت تست عملکرد سیستم فیلتراسیون (بگ فیلتر) دودکش های کارخانجات آسفالت و فولاد مورد استفاده قرار می‌گیرد.`,
